...
using SmartCar.Application.Dtos;
...
namespace SmartCar.Application.Tools
{
    public class JwtTokenGenerator
    {
        public static TokenResponseDto GenerateToken(GetCheckAppUserQueryResult result)
        {
            ...
            claims.Add(new Claim("IsVehiclePartner", result.IsVehiclePartner ? "true" : "false"));
            claims.Add(new Claim("token_version", result.TokenVersion.ToString()));

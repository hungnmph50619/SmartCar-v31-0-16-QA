...
namespace SmartCar.Application.Validators.ReviewValidators
{
    public class UpdateReviewValidator : AbstractValidator<UpdateReviewCommand>
    {
        public UpdateReviewValidator()
        {
            ...
            RuleFor(x => x.CustomerImage).NotEmpty().WithMessage("Vui lòng không để trống ảnh khách hàng!").MinimumLength(10).WithMessage("Vui lòng nhập ít nhất 10 ký tự!").MaximumLength(200).WithMessage("Vui lòng nhập không quá 200 ký tự!");
        }
    }
}

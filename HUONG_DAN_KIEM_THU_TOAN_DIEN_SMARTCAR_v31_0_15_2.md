# HƯỚNG DẪN KIỂM THỬ TOÀN DIỆN SMARTCAR v31.0.15.2
...
| File | Công dụng |
|---|---|
| `SmartCar_FULL_ONE_CLICK_RESET_INSTALL_v31_0_15_2.sql` | Xóa và cài mới toàn bộ database. Chỉ dùng cho môi trường test/demo. |
| `SmartCar_PATCH_FIX_3_LOI_v31_0_15_2.sql` | Vá database đang có, không xóa dữ liệu. |
...
2. Mở `SmartCar_FULL_ONE_CLICK_RESET_INSTALL_v31_0_15_2.sql`.
...
1. Sao lưu database.
2. Mở `SmartCar_PATCH_FIX_3_LOI_v31_0_15_2.sql`.
3. Chạy một lần.
